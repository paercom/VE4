...
-(void)updateSliderValueLabel:(id)sender{
    ...
    [delegate rangeValueOnSliderInWriteInCellDidChange:self];
}
...
- (void)dealloc
{
    ...
    self.candidateNameTextField = nil;
    [super dealloc];
}
