//
//  IRVinstructionsViewController.m
//  ElectoralExperiment
//
...
@interface IRVinstructionsViewController ()

@end

@implementation IRVinstructionsViewController
...
-(void)viewDidAppear:(BOOL)animated {
    [popoverDelegate IRVPopoverDidAppear:self];
}
-(void)viewDidDisappear:(BOOL)animated {
    [popoverDelegate IRVPopoverDidDisappear:self];
}
