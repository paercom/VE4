//
//  PluralityDataViewerViewController.m
//  ElectoralExperiment
//
...
@implementation PluralityDataViewerViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *cellData = [NSString stringWithFormat:@"Voter ID: %-7.0d   Candidate: %@",[voterID integerValue], candidateName];
