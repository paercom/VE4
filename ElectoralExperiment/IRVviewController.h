...
@interface IRVviewController : UIViewController <UIAlertViewDelegate, UITableViewDelegate, UITableViewDataSource, UIPopoverControllerDelegate, IRVPopoverDelegate> {
    
    MySingelton *experimentAdministrator;
    
}

@property (nonatomic, retain) NSMutableArray *voterCandidateSelectionList;

@property (nonatomic, retain) NSMutableArray *candidateList;
@property (nonatomic, retain) IBOutlet UITableView *myTableView;
@property (nonatomic, retain) IBOutlet UITableView *selectedItemsTableView;
@property (retain, nonatomic) IBOutlet UILabel *instructionsHeader;

@property (nonatomic, retain) NSMutableArray *cellReferenceList;

/*
@property (nonatomic, retain) IBOutlet UILabel *candidateOneLabel, *candidateTwoLabel, *candidateThreeLabel;
 */
