//
//  PluralityInstructionsViewController.m
//  ElectoralExperiment
//
...
@interface PluralityInstructionsViewController ()

@end

@implementation PluralityInstructionsViewController
...
- (void)viewDidAppear:(BOOL)animated{
    [popoverDelegate pluralityPopoverDidAppear:self];
}

- (void)viewDidDisappear:(BOOL)animated{
    [popoverDelegate pluralityPopoverDidDisappear:self];
}
