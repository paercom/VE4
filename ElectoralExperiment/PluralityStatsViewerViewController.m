//
//  PluralityStatsViewerViewController.m
//  ElectoralExperiment
//
//  Created by Stefan Agapie on 10/23/11.
...
@implementation PluralityStatsViewerViewController
...
-(void)loadPluralityDataViewer;{
    PluralityDataViewerViewController *pluralityDataViewer = [[PluralityDataViewerViewController alloc] initWithNibName:@"PluralityDataViewerViewController" bundle:nil];
    [self.navigationController pushViewController:pluralityDataViewer animated:YES];
    [pluralityDataViewer release];
}
...
- (void)viewDidLoad
{
    ...
    rightBarButton = [[UIBarButtonItem alloc] initWithTitle:kDataViewerTitle style:UIBarButtonItemStylePlain target:self action:@selector(loadPluralityDataViewer)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *cellData = [NSString stringWithFormat:@"Tally: %-7.0d   Candidate: %@",[candidateTally integerValue], candidateName];
